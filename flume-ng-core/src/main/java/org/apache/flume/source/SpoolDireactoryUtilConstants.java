...
public class SpoolDireactoryUtilConstants {
	...
	public static final String PROPERTY_PREFIX = "kafka.";
	  ...
	  public static final String DEFAULT_JAVA_AUTHENTICATION_PATH = "kafka_conf/kafka_client_jaas.conf";
	  ...
	  public static final String DEFAULT_KRB_CONF_PATH = "kafka_conf/krb5.conf";
